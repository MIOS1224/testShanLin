...
+ (void)showCircleView:(UIView *)view andText:(NSString *)textValue
{
    ...
    loadView = [[LoadingView alloc] initWithFrame:CGRectMake(0, 0, screenWidth, screenHeight) type:LoadingViewCircle];
    loadView.backgroundColor = [UIColor whiteColor];
    loadView.center = view.center;
//    CGFloat width = [self getWidthWithTitle:textValue font:[UIFont systemFontOfSize:14]];
    
    UILabel * label = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 0, 20)];
    label.center = CGPointMake(view.center.x,view.center.y + 65);
    
    label.text = textValue;
    label.backgroundColor = [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:0.6];;
...
- (void)creatAnimation
{
    ...
    CGFloat width = [self getWidthWithTitle:@"qingshaohou ,dengdengdengde......." font:[UIFont systemFontOfSize:14]];
    
    if (self.label == nil) {
        
        self.label = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, width, 20)];
        //    label.center = CGPointMake(view.center.x,view.center.y + 65);
        
        self.label.text = @"qingshaohou ,dengdengdengde.......";
        self.label.layer.backgroundColor = [UIColor redColor].CGColor;
        self.label.textColor = [UIColor whiteColor];
        self.label.font = [UIFont systemFontOfSize:14];
        self.label.layer.cornerRadius = 5;
        
//        [replicatorLayer addSublayer:self.label.layer];
    }
